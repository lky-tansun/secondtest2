...
public class Ygcx2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int Size = new DBHelper2(Ygcx2.this).dbGetUserSize();
		List<Bm> list = new DBHelper2(Ygcx2.this).dbQueryAll();
		...
		btn1.setOnClickListener(new View.OnClickListener() {
			int Size = new DBHelper3(Ygcx2.this).dbGetUserSize();
			
			List<Yg> list = new DBHelper3(Ygcx2.this).dbQueryAll();
			String sex;
			...
			public void onClick(View arg0) {
				...
				if (ckb1.isChecked()) {
					if (ckb2.isChecked()) {
						...
						Toast.makeText(Ygcx2.this, "查询结果如下", Toast.LENGTH_SHORT)
								.show();
					} else {
						for (int i = 0; i < Size; i++) {
							if (list.get(i).getDepartment().equals(TypeResult)) {
					...
					if (ckb2.isChecked()) {
						...
						Toast.makeText(Ygcx2.this, "都不选我怎么查？",
								Toast.LENGTH_SHORT).show();
					}
				}
				adapter = new Adapter2(Ygcx2.this,
						arraylist2);
		...
		btn2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(Ygcx2.this, Zhuye2.class);

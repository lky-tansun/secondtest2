...
public class Gzcx2 extends Activity {    
    ...
    public void onCreate(Bundle savedInstanceState) {    
        ...
        final int Size = new DBHelper4(Gzcx2.this).dbGetUserSize();
        List<Gz> list=new DBHelper4(Gzcx2.this).dbQueryAll();
		...
		btn1.setOnClickListener(new View.OnClickListener() {
			List<Gz> list2=new DBHelper4(Gzcx2.this).dbQueryAll();
			@Override
			public void onClick(View arg0) {
				...
				if (ckb1.isChecked()) {
					...
					arraylist2.add(
						...
						Toast.makeText(Gzcx2.this, "查询结果如下", Toast.LENGTH_SHORT)
								.show();
					} else {
						for (int i = 0; i < Size; i++) {
					...
					if (ckb2.isChecked()) {
						...
						Toast.makeText(Gzcx2.this, "都不选我怎么查？",
								Toast.LENGTH_SHORT).show();
					}
				}
				ArrayAdapter<String> adapter = new ArrayAdapter<String>(Gzcx2.this,
		...
		@Override
		public void onClick(View arg0) {
			Intent intent = new Intent(Gzcx2.this,Zhuye2.class);

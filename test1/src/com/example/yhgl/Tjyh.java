...
public class Tjyh extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (username.equals(null) || username == ""
					...
					Toast.makeText(Tjyh.this, "用户名或密码不得为空！",
							Toast.LENGTH_SHORT).show();
				} else {
					String confirmPwd = et6.getText() + "";
					if (!password.equals(confirmPwd)) {
						Toast.makeText(Tjyh.this, "两次输入密码不一致！",
								Toast.LENGTH_SHORT).show();
					} else {
						if (userDao.dbQueryOneByUsername(username) == null) {
							...
							Toast.makeText(
									...
									.show();
							Intent intent = new Intent(Tjyh.this,Login.class);
							startActivity(intent);
						} else {							
							Toast.makeText(Tjyh.this, "该用户已被注册",
									Toast.LENGTH_SHORT).show();
						}
					}
				}
		...
		btn3.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(Tjyh.this,Yhgl.class);
				startActivity(intent);
			}
			});
}
